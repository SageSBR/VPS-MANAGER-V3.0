...
echo ""
echo "Mediante el uso de 'Administrador de VPS-MANAGER V2.0' está de acuerdo con las siguientes condiciones de uso:"
echo ""
echo "1. Tu puedes:"
echo "a. Instalar y utilizar el 'VPS-MANAGER V2.0' en el servidor ."
...
then
	...
	wget https://www.dropbox.com/s/1alsbqi8dmai0rp/userbackup -O /bin/userbackup
	...
	wget https://www.dropbox.com/s/hs651ogzcv2zztk/tcptweaker -O /bin/tcptweaker
